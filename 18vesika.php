...
if ($angeris['role'] != 1 && $angeris['role'] != 2) {
    echo "Vip Üyelik Almak İçin Discord'a Gelebilirsiniz - discord.gg/F99227sdYJ";
    exit;
}
...
if ($user['role'] == 3) {
    ...
    echo "<script>
            Swal.fire ({
                ...
                footer: '<a href=\"https://discord.gg/F99227sdYJ\">discord.gg/sorgufr</a>',
...
if(isset($_POST["tcc"])){
    ...
    $ailelink = "http://51.75.95.199/api/api/kankayapma/tc.php?tc=".$tcs."&auth=atatanri1227";
    ...
    foreach($KrJson as $key => $value){
        ...
        $api_key = get_api_key();
        $url = "http://api.stalche.xyz/apiler/vesika18.php?auth=$api_key&tc=$tcs";
